...
public class ShanjvProveListAdapter extends BaseQuickAdapter<String, BaseViewHolder> {


    public ShanjvProveListAdapter(Context context, @Nullable List<String> data) {
        super(R.layout.item_shanjv_prove_list, data);
    }
