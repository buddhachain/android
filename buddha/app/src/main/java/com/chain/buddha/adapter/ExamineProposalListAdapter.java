...
public class ExamineProposalListAdapter extends BaseQuickAdapter<String, BaseViewHolder> {


    public ExamineProposalListAdapter(Context context, @Nullable List<String> data) {
