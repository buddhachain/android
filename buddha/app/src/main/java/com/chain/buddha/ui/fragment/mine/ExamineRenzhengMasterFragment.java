...
import com.chain.buddha.adapter.ExamineRenzhengMasterAdapter;
 ...
 */
public class ExamineRenzhengMasterFragment extends BaseFragment {

    @BindView(R.id.rv_list)
    RecyclerView mRv;

    private ExamineRenzhengMasterAdapter mAdapter;
    private List<String> mList;

    public ExamineRenzhengMasterFragment() {
    ...
    protected void init() {
        ...
        mList = new ArrayList<>();
        mAdapter = new ExamineRenzhengMasterAdapter(mContext, mList);
