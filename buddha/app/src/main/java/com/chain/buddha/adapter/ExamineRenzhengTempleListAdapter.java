...
public class ExamineRenzhengTempleListAdapter extends BaseQuickAdapter<String, BaseViewHolder> {


    public ExamineRenzhengTempleListAdapter(Context context, @Nullable List<String> data) {
        ...
        try {
            ...
            baseViewHolder.getView(R.id.tv_proof).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    String profImage = IpfsUtils.GET_IPFS_FILE_HEAD + list[4];
