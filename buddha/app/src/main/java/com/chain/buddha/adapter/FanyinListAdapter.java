...
public class FanyinListAdapter extends BaseQuickAdapter<String, BaseViewHolder> {


    public FanyinListAdapter(Context context, @Nullable List<String> data) {
        super(R.layout.item_fanyin_list, data);
    }
