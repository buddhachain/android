...
import com.chain.buddha.adapter.ExamineRenzhengSiyuanListAdapter;
 ...
 */
public class ExamineRenzhengSiyuanFragment extends BaseFragment {

    @BindView(R.id.rv_list)
    RecyclerView mRv;

    private ExamineRenzhengSiyuanListAdapter mAdapter;
    private List<String> mList;

    public ExamineRenzhengSiyuanFragment() {
    ...
    protected void init() {
        ...
        mList = new ArrayList<>();
        mAdapter = new ExamineRenzhengSiyuanListAdapter(mContext, mList);
