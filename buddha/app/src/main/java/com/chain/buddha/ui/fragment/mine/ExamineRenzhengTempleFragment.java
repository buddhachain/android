...
import com.chain.buddha.adapter.ExamineRenzhengTempleListAdapter;
 ...
 */
public class ExamineRenzhengTempleFragment extends BaseFragment {

    @BindView(R.id.rv_list)
    RecyclerView mRv;

    private ExamineRenzhengTempleListAdapter mAdapter;
    private List<String> mList;

    public ExamineRenzhengTempleFragment() {
    ...
    protected void init() {
        ...
        mList = new ArrayList<>();
        mAdapter = new ExamineRenzhengTempleListAdapter(mContext, mList);
        ...
        mAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(@NonNull BaseQuickAdapter<?, ?> adapter, @NonNull View view, int position) {
                try {
                    ...
                    if (StringUtils.equals(list[5], "0")) {
                        //未通过审核
                        approve(list[0]);
                    }
                } catch (Exception e) {
    ...
    void approve(String id) {
        XuperApi.approveTemple(id, new ResponseCallBack<String>() {
            @Override
            public void onSuccess(String resp) {
