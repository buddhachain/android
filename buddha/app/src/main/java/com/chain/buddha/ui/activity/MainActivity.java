...
import com.chain.buddha.ui.fragment.JidiantangFragment;
...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mFragment[1] = new FoyouFragment();
            mFragment[2] = new XiuxingFragment();
            mFragment[3] = new JidiantangFragment();
        ...
        mBottomBar.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                refreshFragment(menuItem.getItemId());
                return true;
            }
        });
    ...
    private void refreshFragment(int resId){
        int index = 0;
    ...
    public void select(int resId) {
        mBottomBar.setSelectedItemId(resId);
    }
