...
import com.chain.buddha.ui.live.ECommerceFragment;
import com.chain.buddha.ui.live.LivePrepareActivity;
...
public class RoomFragment extends AbstractFragment implements View.OnClickListener {
    ...
    private static final int TAB_TEXT_VIEW_INDEX = 0;
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.live_room_start_broadcast) {
            if (config().appIdObtained()) {
                Class<?> activity = LivePrepareActivity.class;
