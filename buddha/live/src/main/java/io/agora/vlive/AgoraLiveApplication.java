...
public class AgoraLiveApplication {
    ...
    private static AgoraLiveApplication agoraLiveApplication;
    ...
    public static AgoraLiveApplication getAgoraLiveApplication() {
        return agoraLiveApplication;
    }

    public static Context getContext() {
        return agoraLiveApplication.mContext;
    }

    public static void init(Context context) {
        agoraLiveApplication = new AgoraLiveApplication();
        agoraLiveApplication.create(context);
    }
